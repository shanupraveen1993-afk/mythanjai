...
export function RobotHero({
  ...
  return (
    ...
    >
      ...
      {/* ── 3rd Fold: Bottom Callout Banner ──────────────────────── */}
      <div className="w-full bg-white py-14 md:py-20 px-4 sm:px-6 relative z-10 border-t border-slate-200/80">
        <div className="max-w-5xl mx-auto">
          <div className="bg-gradient-to-r from-yellow-400 via-amber-500 to-amber-600 text-slate-955 p-8 md:p-12 rounded-3xl shadow-2xl flex flex-col sm:flex-row items-center justify-between gap-6 text-center sm:text-left border border-yellow-400">
            <div className="flex flex-col gap-1">
