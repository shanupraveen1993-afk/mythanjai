...
export default function TamilSloganBanner() {
  ...
  return (
    <div 
      className="w-full bg-[#E2E6FE] border-b border-indigo-200/80 py-2 px-4 sm:px-8 flex items-center justify-center text-center font-sans shadow-2xs select-none relative transition-all mt-0 mb-0"
    >
