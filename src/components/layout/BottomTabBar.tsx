...
export default function BottomTabBar({ activeTab, onTabChange }: BottomTabBarProps = {}) {
  ...
  return (
    <nav
        className="md:hidden fixed bottom-0 left-0 right-0 z-40 w-full bg-white text-slate-800 border-t border-slate-200/90 shadow-[0_-8px_30px_rgba(0,0,0,0.1)] pointer-events-auto select-none"
