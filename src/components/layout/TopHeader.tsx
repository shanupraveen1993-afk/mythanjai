...
export default function TopHeader({
  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 bg-[#0F172A] border-b border-slate-800 text-white backdrop-blur-xl flex-col justify-end transition-transform duration-300 ${
