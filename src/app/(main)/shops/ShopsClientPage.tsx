    ...
    <div className="flex flex-col gap-3 pb-24 w-full font-sans">
      ...
      <div className="sticky top-14 z-40 bg-white border-b border-slate-200 py-3 mb-3 flex items-center justify-between gap-2 shadow-2xs">
        ...
        <button
          ...
          className="flex items-center gap-1 bg-purple-600 hover:bg-purple-500 text-white font-bold px-3 py-1.5 rounded-lg text-xs transition-all border border-purple-500 cursor-pointer shadow-2xs"
        >
