    ...
    <div className="flex flex-col gap-6 mt-6 md:mt-8 pt-2 pb-12">
      ...
      {!selectedCategory ? (
        ...
        <div className="flex flex-col gap-5">
          ...
          <div className="sticky top-[57px] z-30 bg-amber-50/85 backdrop-blur-md py-2.5 px-4 border border-amber-200/80 rounded-2xl shadow-xs flex items-center justify-between mt-1">
            <select
              value={sortBy}
              onChange={(e) => setSortBy(e.target.value as any)}
              className="bg-white/90 border border-amber-200/90 rounded-xl px-3.5 py-2 text-xs font-black focus:outline-none cursor-pointer text-slate-800 shrink-0 shadow-xs"
            >
