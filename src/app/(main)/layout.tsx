...
function MainLayoutContent({
  ...
  return (
    <div className={`w-full flex flex-col relative bg-[#f0f2f5] font-sans ${layoutClasses}`}>
      ...
      <main className={`flex-1 w-full bg-[#f0f2f5] ${isStandaloneView ? "p-0 max-w-none m-0" : "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 md:pt-14 pb-24 md:pb-8"}`}>
        {children}
      </main>
