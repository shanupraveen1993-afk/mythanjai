          ...
          <div className="relative z-10 flex flex-col gap-3 max-w-xl">
            ...
            <div className="flex items-center gap-2 mt-1">
              <button
                ...
                className="flex items-center gap-1.5 bg-yellow-500 hover:bg-yellow-400 active:scale-95 text-slate-950 font-black text-xs px-4 py-2.5 rounded-xl transition-all shadow-lg border border-yellow-400 cursor-pointer"
              >
