...
export async function GET() {
  const cdnUrl = "https://raw.githubusercontent.com/shanupraveen1993-afk/mythanjai/main/public/NammaThanjai-v51.apk";
  ...
  try {
    ...
    headers.set("Content-Disposition", 'attachment; filename="NammaThanjai-v51.apk"');
